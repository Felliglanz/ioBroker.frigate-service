...
// We don't depend on @iobroker/gui-components: it pulls in @mui/material +
// @mui/icons-material (10k+ icon modules) as peer deps purely for its DialogSelectID
// dialog, which we only use as an optional convenience - every field it fills also
// accepts a manually typed state ID. The "Select" buttons below already degrade
// gracefully (disabled) when this is unset.
const DialogSelectID = null;

const UI_VERSION = 'gen2';
...
export default function FrigateServiceItemsEditor(props) {
