...
- **Admin UI**:
  - Tab **Global**: Frigate API/Instanz, Kamera-Registry, Notification Targets
...
- **Filter**: Event-Typ(en), Label (z.B. `person`), Score, Throttle/Dedupe
...
## Status / bekannte offene Punkte

- Kamera-Discovery ist in der UI verfügbar.
- Offenes TODO: weitere Frigate-Event-Felder (z.B. `entered_zones`, `sub_label`) einlesen und im Filter/Message nutzen.
